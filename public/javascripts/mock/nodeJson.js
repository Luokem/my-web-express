// 'use strict'
const fs = require('fs')
const dataURL = '/public/javascripts/server-db/login.json'
const dataURL2 ='/public/javascripts/server-db/handlerPrice.json' 
const dataURL3 = '/public/javascripts/server-db/getTableData.json'
...
showQianduan: function(data) {
   ...
   fs.readFile('./public/javascripts/server-db/user/'+ username +'.json','utf8',(err, ret) => {
   	if(err) {
   		throw err;
   		reject({err: '1',tip: '服务器错误'})
   	}
